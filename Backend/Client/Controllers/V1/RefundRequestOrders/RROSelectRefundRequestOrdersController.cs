...
/// <summary>
/// RROSelectRefundRequestOrdersController - Select refund request orders
/// </summary>
[Route("api/v1/[controller]")]
[ApiController]
public class RROSelectRefundRequestOrdersController : AbstractApiGetController<RROSelectRefundRequestOrdersRequest, RROSelectRefundRequestOrdersResponse, List<RROSelectRefundRequestOrdersEntity>>
{
    ...
    public RROSelectRefundRequestOrdersController(IIdentityService identityService, IRefundRequestOrderService refundRequestOrderService, IIdentityApiClient identityApiClient)
    {
    ...
    {
        return _refundRequestOrderService.SelectRefundRequestOrders();
    }
