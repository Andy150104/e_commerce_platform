<template>
    <div class="hidden md:flex space-x-4">
      ...
      >
        ...
        <button
          class="w-full mt-4 bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700">
          Buy now
        </button>
    ...
    <!-- Mobile Carousel -->
    <div class="md:hidden">
      <swiper :slides-per-view="1" space-between="10" class="w-full">
