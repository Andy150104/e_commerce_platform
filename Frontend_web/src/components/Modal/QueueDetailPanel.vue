<template>
  <div class="mt-2 p-4 border border-gray-300 bg-gray-50 rounded-lg shadow">
    <div class="flex items-center space-x-4">
      <img 
        :src="detail.userImage || 'https://media.istockphoto.com/id/1409329028/vector/no-picture-available-placeholder-thumbnail-icon-illustration-design.jpg?s=612x612&w=0&k=20&c=_zOuJu755g2eEUioiOUdz_mHKJQJn-tDgIAhQzyeKUQ='"
        alt="Profile Picture"
    ...
    <div class="mt-6 p-4 rounded-lg border border-gray-200 bg-gray-50 w-full max-h-40 overflow-y-auto overflow-x-hidden break-all whitespace-pre-wrap">
