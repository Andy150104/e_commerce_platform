      ...
      <ul class="space-y-2 font-medium">
        <li>
          <DropDownControl
            ...
            :option="[
              ...
              {
                link: '/DashBoard/UserAddress',
                childItemName: 'Address',
              },
              {
                link: '#',
                childItemName: 'Change password',
              },
            ]"
          >
            <template #body>
        ...
        <li v-if="verifyTokenStore.roleName === 'PlannedCustomer'">
          <DropDownControl
            ...
            :option="[
              {
                link: '/DashBoard/PlannedCustomer',
                childItemName: 'My Exchange',
              },
              {
                link: '/DashBoard/PlannedCustomer/Recheck',
                childItemName: 'Send request recheck',
              },
            ]"
          >
            <template #body>
              ...
              >
                <path
                  ...
                  stroke-width="2"
                  d="M17 20h5v-2a4 4 0 00-3-3.87M12 20v-2a4 4 0 013-3.87M7 20v-2a4 4 0 013-3.87M12 4a4 4 0 110 8 4 4 0 010-8z"
                />
              </svg>
            </template>
          </DropDownControl>
