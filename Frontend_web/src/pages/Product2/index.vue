<template>
  <div class="flex items-center justify-center min-h-screen">
    <div class="w-full max-w-lg p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      <div class="mb-4">
        <label for="file-upload" class="block text-lg font-semibold mb-2 dark:text-white">Upload Image</label>
        <div
        ...
        >
          ...
          <p class="text-gray-600 dark:text-gray-400">
            ...
            <span class="text-blue-500 underline">chọn file</span> để upload (tối đa 5 ảnh)
          </p>
        </div>
      </div>
