      ...
      <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          <div
            ...
            :key="index"
            class="flex items-center bg-white shadow rounded-lg overflow-hidden border"
          >
            <!-- Product Image -->
            <img
              :src="item.image"
            ...
            <div class="flex items-center space-x-3 px-4">
              <button
                class="px-3 py-2 bg-gray-300 hover:bg-gray-400 text-gray-900 rounded-full text-lg"
            ...
            <!-- Remove Button -->
            <button
              class="px-3 py-2 text-red-600 hover:text-red-800 font-semibold"
        ...
        <div class="lg:col-span-1 space-y-6">
          <div class="p-6 bg-white shadow rounded-lg border">
            ...
            <button
              class="mt-6 w-full py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-lg font-semibold"
            >
              Proceed to Checkout
            </button>
            <a
