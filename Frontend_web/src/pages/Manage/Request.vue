...
<script setup lang="ts">
  ...
  import { useMRRManageRefundRequestStore } from '@PKG_SRC/stores/Modules/Manage/MRRManageRefundRequestStore'
  import { XmlLoadColumn } from '@PKG_SRC/utils/xml'
  import { useForm } from 'vee-validate'

  const store = useMRRManageRefundRequestStore()
  ...
  onMounted(async () => {
    await store.GetAllRefundRequest()
  })
</script>
